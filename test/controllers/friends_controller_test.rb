...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference("Friend.count") do
      post friends_url, params: { friend: { age: @friend.age, mail: @friend.mail, name: @friend.name } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { age: @friend.age, mail: @friend.mail, name: @friend.name } }
